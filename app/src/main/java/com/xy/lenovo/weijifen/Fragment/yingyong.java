...
public class yingyong extends Fragment {
    private final String[] title={"应用付款情况","应用管理"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.yingyong,container,false);
        mFragments.add(new fukuan());
        mFragments.add(new guanli());
        viewPager = (ViewPager) view.findViewById(R.id.ying2);
        mAdapter = new Adapter(getChildFragmentManager(),mFragments);
        viewPager.setAdapter(mAdapter);
        slidingTabLayout = (SegmentTabLayout) view.findViewById(R.id.ying1);
